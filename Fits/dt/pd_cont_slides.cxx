...
void pd_cont_slides()
{
    ...
    // PD cont
    ROOT::RDataFrame pd {"Sel_Tree", "../../PostAnalysis/RootFiles/Pipe3/pd_as_dt_contamination.root"};
    auto hpd {pd.Filter([](ActRoot::MergerData& mer) { return mer.fSilEs.front() > 9; }, {"MergerData"})
                  .Histo1D(E796Fit::Exdt, "Ex")};
    Fitters::FitPS(hpd.GetPtr(), "pol0", false, true);
    ...
    Fitters::RunFit(hEx.GetPtr(), exmin, exmax, model, inter.GetInitial(), inter.GetBounds(), inter.GetFixed(),
                    ("./Outputs/test.root"), "20O(d,t)", {}, false, true);
