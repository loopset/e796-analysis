#include "./Simulation_d4He_E796.cpp"
#include "./Plotter.cpp"
...
void Runner(TString what = "plot", bool standalone = true)
{
    ...
    if(neutronPS == 0 && protonPS == 0)
        Eexs = {0., 0.115, 0.587, 0.742, 1.170, 1.734, 2.210, 2.405, 2.614, 5.886};
    ...
    if(what.Contains("simu"))
    {
        ...
        {
            Simulation_d4He_E796(
                                 beam, target, light, heavy,
                                 neutronPS, protonPS,
                                 T1,
                                 Eex,
                                 standalone
