...
plt.savefig(
    "./Outputs/mini_slides.png",
    dpi=300,
    bbox_inches=None,
    pad_inches=0,
)

# # Add a box around the entire figure with padding
# rect = mplpatch.Rectangle((0.02, 0.02), 0.96, 0.96,
#                            transform=fig.transFigure,
