...
# Theoretical
theos = dt.build_theos(gated=True, c2s_thresh=0.07, with_wbt=True)  # type: ignore
...
# Settings
theos = [sfo, sfo1, wbt]
cents = [cents[0], cents[1], cents[2], cents[-1]]
